...
public class CoordinatesGenerator {
    ...
    public Coordinate generateRandomCoordinate(final Map<Coordinate, Tile> board) {
        final int START = 0;
        return getValidRandomCoordinate(board, START, START, this.configuration.getLabyrinthHeight(), this.configuration.getLabyrinthWidth());
    }
    ...
    private Coordinate calculateCirclePoint(int radius, double angle, Coordinate center) {
